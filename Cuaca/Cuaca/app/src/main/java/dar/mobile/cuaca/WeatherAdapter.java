...
public class WeatherAdapter extends RecyclerView.Adapter {
    ...
    public WeatherAdapter(Context ctx, List<Weather> cuaca) {
        this.ctx = ctx;
        this.cuaca = cuaca;
    }
    ...
    class VHWeather extends RecyclerView.ViewHolder{
        ...
        public VHWeather(@NonNull View itemView) {
            ...
            this.tvDailyPred = itemView.findViewById(R.id.tvDailyPred);
            this.ikon = itemView.findViewById(R.id.imgWeatherIcon);
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new VHWeather(
                LayoutInflater.from(this.ctx).inflate(R.layout.daily_item, parent, false)
        );
    }
