...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.btnVolley = this.findViewById(R.id.btnVolley);
        btnVolley.setOnClickListener(this);

        this.btnRetrofit = this.findViewById(R.id.btnRetrofit);
    ...
    public void onClick(View view) {
        ...
        this.requestQueue.add(sr);
            ...
            Call<WeatherResult> call = weatherService.getWeatherForecast(
                    latitude, // latitude
                    longitude, // longitude
                    "weathercode", // daily
            ...
            call.enqueue(new Callback<WeatherResult>() {
                ...
                public void onResponse(Call<WeatherResult> call, retrofit2.Response<WeatherResult> response) {
                    if (response.isSuccessful()) {
                        ...
                        WeatherResult.CurrentWeather currentWeather = weatherResult.getCurrentWeather();
                        WeatherResult.DailyWeather dailyWeather = weatherResult.getDailyWeather();
                        ...
                        for (int i = 0; i < time.length; i++) {
                            ...
                            cuaca.add(new Weather(weathercode, date));
                        }

                        Intent dataRetrofit = new Intent(MainActivity.this, FirstPage.class);
                        ...
                        bundle.putSerializable("cuaca", (Serializable) cuaca);
    ...
    public void onResponse(JSONObject response) {
        try {
            ...
            for (int i = 0; i < time.length(); i++){
                ...
                cuaca.add(new Weather(code, tanggal));
            }
            ...
            Intent dataVolley = new Intent(MainActivity.this, FirstPage.class);
